...
public class ForeignKeyModel implements Serializable{
	...
	/**
	 * @param pkTableCat 设置主键表的类别(一般为数据库名，可以为空)
	 */
	...
	/**
	 * @param pkTableSchem 设置主键表的架构(一般为所有者名称，可以为空)
	 */
	...
	/**
	 * @param pkColumnName 设置该外键所对应的主键列名称
	 */
	...
	/**
	 * @param fkTableCat 设置该外键所在表的类别(一般为数据库名，可以为空)
	 */
	...
	/**
	 * @param fkTableSchem 设置该外键所在表的架构(一般为用户名，可能为空)
	 */
	...
	/**
	 * @param keySeq 设置该键在键序列中的顺序（多个键的时候）
	 */
	...
	/**
	 * @param deferrability 设置是否可延迟约束检查。
	 */
