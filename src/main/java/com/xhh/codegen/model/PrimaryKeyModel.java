...
public class PrimaryKeyModel implements Serializable{
	...
	/**
	 * @param tableCat 设置表目录(一般为数据库名，可以为空)
	 */
	...
	/**
	 * @param tableSchem 设置表架构(一般为所有者名称，可以为空)
	 */
	...
	/**
	 * @param keySeq 设置该主键在键序列中的序号（多个键的时候）
	 */
