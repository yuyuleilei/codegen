...
public class TableModel  implements CycleRecoverable{
	...
	/**
	 * @param catalog 设置表的目录名称(一般为数据库名，可以为空)
	 */
	...
	/**
	 * @param tableType 设置表的类型。典型的类型是 "TABLE"、"VIEW"、"SYSTEM TABLE"、"GLOBAL TEMPORARY"、"LOCAL TEMPORARY"、"ALIAS" 和 "SYNONYM"。
	 */
	...
	/**
	 * @param primaryKeyList 设置该表下包含的所有主键模型
	 */
	...
	/**
	 * @param importedKeyList 设置该表的外键模型集合（引入）
	 */
	...
	/**
	 * @param exportedKeyList 设置该表的外键模型集合（导出）
	 */
